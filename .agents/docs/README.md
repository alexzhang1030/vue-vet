...
| Reactivity graph facts, tracking scopes, module summaries, or tracer completeness | [reactivity tracer](./reactivity-tracer.md), [gotchas](./gotchas.md), and [literature matrix](./research/reactivity-tracer-literature.md) | Defines the static reactivity tracing library goals, ladder, non-goals, and current baseline. |
