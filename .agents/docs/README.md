...
| Reactivity graph facts, tracking scopes, module summaries, or tracer completeness | [reactivity tracer](./reactivity-tracer.md), [gotchas](./gotchas.md), [literature matrix](./research/reactivity-tracer-literature.md), [oracle](../../crates/vue_vet_reactivity/oracle/README.md) | Static tracer goals, A1/oracle reorientation, under-approx evidence. |
