...
| Dependencies, tool ownership, Rust-only constraints, or version pins | [technology stack](./technology-stack.md) and [Vize compatibility baseline](../../docs/vize-compatibility.md) | Explains why Vize, Oxc, and ast-grep have different jobs, why analysis dependencies are pinned, and how Vize upgrades are validated. |
