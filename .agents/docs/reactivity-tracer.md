...
Contract version: **`REACTIVITY_GRAPH_VERSION = 19`** (v18 + `RemovableRef` Factory
seeds + `typeof` import re-export `ForwardReturn`; v18 typed function-callback
formals; v17 `const x = expr as Ref` declarator assertions; v16 generic context
