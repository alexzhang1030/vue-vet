...
| Tier | Meaning | Count |
| --- | --- | ---: |
| `tracer` | Needs `vue_vet_reactivity` graph facts (read kinds, guards, scopes, prop edges, binding kinds) | 79 |
...
Total registered **file** rules (builtins + practice): **149**.
...
- [`vue-vet/reactivity/no-controlled-computed-stale-result-demand`](./reactivity/no-controlled-computed-stale-result-demand.md) `tracer`
...
- [`vue-vet/reactivity/no-ignorable-async-ignore-window`](./reactivity/no-ignorable-async-ignore-window.md) `tracer`
...
- [`vue-vet/reactivity/no-pre-flush-template-ref-demand`](./reactivity/no-pre-flush-template-ref-demand.md) `tracer`
...
- [`vue-vet/reactivity/no-reactive-private-field-access`](./reactivity/no-reactive-private-field-access.md) `tracer`
...
- [`vue-vet/reactivity/no-v-memo-blocked-ref-demand`](./reactivity/no-v-memo-blocked-ref-demand.md) `tracer`
