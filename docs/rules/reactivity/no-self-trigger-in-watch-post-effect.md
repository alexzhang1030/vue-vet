...
const count = ref(0)
watchPostEffect(() => { count.value = count.value + 1 })
</script>
...
- `fixtures/rules/no-self-trigger-in-watch-post-effect/valid/safe.vue`
