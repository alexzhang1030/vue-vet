...
Maxima are ceil(candidate bytes * 1.03) for the `5f97222` matrix binaries (workflow run 34828558719);
...
another 131 KB there. Re-pin the candidate to the rule PR's own matrix run when
