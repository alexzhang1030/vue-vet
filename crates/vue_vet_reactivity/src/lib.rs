...
pub use trace::{
  ...
  TraceModulesReport, TraceModulesStats, TracerPlugin, ValueBag, ValueBagEntry,
  flatten_named_api_bags, is_named_api_bag_callee, merge_declaration_implementation_summary,
  named_api_bag, prepare_standalone_module_source, trace_modules,
