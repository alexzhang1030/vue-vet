...
use super::*;
use crate::source_contracts::collect_source_contract_facts_with_full_stats;
...
fn contract_full_stats(
  source: &str,
) -> (vue_vet_core::SourceContractFacts, crate::source_contracts::SourceContractStats) {
  ...
  collect_source_contract_facts_with_full_stats(
    &built.semantic,
    &line_index,
    source,
    0,
